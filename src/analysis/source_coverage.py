...
from ..db.queries import (
    ...
    get_person_facts,
    get_person_sources,
    get_persons_without_sources,
    get_facts_without_sources,
    get_parents,
)
...
def prioritize_source_research(root_person_id: str, generations: int = 4) -> List[Dict[str, Any]]:
    ...
    while to_visit:
        ...
        priority_score = generation_score + vital_missing_score + important_missing_score + no_sources_bonus
        ...
        if priority_score > 0:
            person_priorities.append({
                ...
                'missing_events': [
                    f['fact_type'] for f in coverage['missing_vital_events']
                ] + [
