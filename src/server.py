        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    "root_person_id": {
                        "type": "string",
                        "description": "Root person of tree"
                    },
        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    "root_person_id": {
                        "type": "string",
                        "description": "Root person for the tree"
                    },
                    "generations": {
                        "type": "integer",
        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    "root_person_id": {
                        "type": "string",
                        "description": "Root person for analysis"
                    },
                    "focus_area": {
                        "type": "string",
...
async def call_tool(name: str, arguments: dict) -> list[TextContent]:
    ...
    try:
        ...
        if name == "detect_name_duplicates":
            ...
            result = tool_find_duplicates(
                threshold=arguments.get("threshold", 0.85)
            )
        elif name == "compare_persons":
            result = tool_compare_persons(
                person_id_a=arguments["person_id_a"],
                person_id_b=arguments["person_id_b"]
            )
        elif name == "generate_person_profile":
            result = tool_generate_person_profile(
                person_id=arguments["person_id"]
            )
